            ...
            <div class="col-md-2" ng-repeat="floor in slotData.data.floor">
                ...
                <span ng-repeat="slot in floor">
                    <span ng-if="slot.status==='AV'">
                        <span class="btn btn-default room" role="button"> @{{  slot.associated_room.room }}</span><br/>
                    </span>
                    <span ng-if="slot.status==='NA'">
                        <span class="btn btn-default room disabled" role="button"> @{{  slot.associated_room.room }}</span><br/>
                    </span>
                </span>
            </div>
