            ...
            <div class="col-md-2" ng-repeat="floor in slotData.data.floor">
                ...
                <span ng-repeat="slot in floor">
                    <span ng-if="slot.status==='AV'">
                        <a href="/changeroom/@{{slot.id}}" class="btn btn-default room" role="button"> @{{  slot.associated_room.room }}</a><br/>
                    </span>
                    <span ng-if="slot.status==='NA'">
                        <a class="btn btn-default room disabled" role="button"> @{{  slot.associated_room.room }}</a><br/>
                    </span>
                </span>
            </div>
